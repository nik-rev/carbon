export const birthdate = new Date("2006-08-14").getTime();
export const age = Math.abs(new Date(Date.now() - birthdate).getUTCFullYear() - 1970);

Hi, my name is Nikita Revenco. I'm {age} and from England. 🇬🇧
