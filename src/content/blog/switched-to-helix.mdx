---
title: So I gave Helix a try, and I'm never going back to Neovim
date: 2025-04-08
---
...
Sometimes you just want to open your text editor and use it to write code. But when you have bugs you need to fix and dozens of github issues it becomes old really fast.

I loved Neovim a lot and the mouse-less terminal lifestyle I've gotten thanks to it, but the amount of time I spent on my editor vs actually using it was too much. So I was just thinking of switching back to VSCode and using vim motions plugin.

But also around this time I've gotten really interested in Rust. I switched some of my programs to ones written in Rust, such as [WezTerm](https://wezfurlong.org/wezterm/index.html). Notably, Neovim isn't written in Rust. I was wondering if there was an editor which _is_, and I found one! The [Helix Editor](https://helix-editor.com/).

I decided to give it a try, and I was _seriously impressed_. Not only did it do literally everything I want Neovim to be out of the box with ZERO configuration, its editing model was also signifincalty more intuitive than Neovim's. I also found myself way more productive with Helix due to Helix's multiple cursor feature.
