...
description: How do you quote someone with credit, in a semantically correct way?
---
...
1. A `cite` element [should refer to *work* and not *people*](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/cite#usage_notes).
